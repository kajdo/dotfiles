...
-- Buffer handling
vim.keymap.set('n', '<leader>bc', ':CloseCurrentBuffer<CR>', { noremap = true, silent = true, desc = 'close current buffer' })
...
-- info echo
vim.keymap.set('n', '<leader>if', ':echo "Filetype: "&ft<CR>', { noremap = true, silent = true, desc = 'info echo filetype' })
